...
rabbit-client provides a simple and automatic configuration to work with with [rabbitmq](https://www.rabbitmq.com):  
- pub/sub and [Dead Letter Exchanges](https://www.rabbitmq.com/dlx.html);  
